...
export default class EZPlayerExample_RN extends Component {
  ...
  fetchData() {
    let dataList = [
      ...
      },
      {
        id: 2,
        title: 'title2',
        url: 'http://baobab.wdjcdn.com/1456459181808howtoloseweight_x264.mp4',
      },
      {
        id: 3,
        title: 'title3',
      ...
      },
      {
        id: 6,
        title: 'title6',
        url: 'http://v.yoai.com/femme_tampon_tutorial.mp4',
      },
      {
        id: 7,
        title: 'title7',
      ...
      },
      {
        id: 8,
        title: 'title8',
        url: 'http://cdn3.viblast.com/streams/hls/airshow/playlist.m3u8',
      },
      {
        id: 9,
        title: 'title9',
  ...
  renderCell(info) {
    ...
    return <TablePlayerCell style={styles.cell} body={body} />;
  }
  ...
  onViewableItemsChangedRef = (info) => {
    // console.log(info)
    let changedArray = info.changed;
    for (let changedInfo of changedArray.values()) {
      if (
        this.state.playerIndex === changedInfo.index &&
        !changedInfo.isViewable
      ) {
        this.setState({
          playerIndex: -1,
        });
    ...
    return (
      <View style={styles.container}>
        <FlatList
          ...
          onViewableItemsChanged={this.onViewableItemsChangedRef}
        />
      </View>
    );
  }
